...
public class FormHandler extends Activity implements OnClickListener, OnFocusChangeListener,TextWatcher  {
	...
	private ArrayList<LinearLayout> sigLayout = new ArrayList<LinearLayout>();
...
//	private View sigcap;
	...
	private void gatherData(){
		int x=0;
		Log.d("SIZE", String.valueOf(fields.size()));
	...
	//	fielddata.addAll(fields);
		mainLayout = (LinearLayout)findViewById(R.id.infobar);
		//mainLayout.add((LinearLayout)findViewById(R.id.infobar));
		sigLayout.add((LinearLayout)findViewById(R.id.sigbar));
		sigLayout.add((LinearLayout)findViewById(R.id.sigbarView));
		sigLayout.add((LinearLayout)findViewById(R.id.scrollbar));
		...
		mainLayout.addView(projectform, 1);
	...
	private int removeOverlay() {
		...
		case 4: mainLayout.removeView(trainform);
				...
				return 4;
/*		case 5: mainLayout.removeView(sigcap);
				for(LinearLayout layer:sigLayout){
	...
	protected void setOverlay(int x){
		...
		switch(x){
			...
			case 4:mainLayout.addView(trainform, 1);
					...
					return;
/*			case 5:	mainLayout.addView(sigcap, 1);
					for(LinearLayout layer:sigLayout){
						layer.setVisibility(8);
					}
					prefs.edit().putInt("STATE", 5).apply();
					return; */
		}
		return;
	}
